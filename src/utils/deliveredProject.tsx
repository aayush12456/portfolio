...
import apnapan from '../assets/DeliveredProjects/apnapan.png'
import apnapanMatches from '../assets/DeliveredProjects/apnapanMatch.png'
export const deliveredProjects=[
    ...
    },
    {
        img:apnapan,
        img1:apnapanMatches,
        content:"This full-stack MERN project is a comprehensive dating website where users can perform essential operations like matching, pairing, liking, and skipping profiles. It features robust authentication methods, including traditional email/password and OTP-based authentication for added security. To ensure genuine profiles, it incorporates live video recording during user registration. The platform provides real-time email notifications for new visitors or pairings and SMS alerts when someone likes a user's profile. Fully responsive and deployed on Netlify, this project showcases advanced functionality and a seamless user experience across all devices. ",
        technology:'ReactJs , Nodejs , MongoDb , Tailwind Css ',
        forData:'Personal Project',
        Project:'Create web based MERN app which is a dating website and do all operations like matching ,pairing , visitor and so on.. ',
        link:'https://apnapandating.netlify.app/',
        title:'Apna-Pan'
    }
]